...
const AuthContainer = () => {
  ...
  return (
    <div>
      {/* Trigger buttons - you can style and position these as needed */}
      <button 
        onClick={handleOpenLogin}
        className="bg-red-700 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-md mr-2"
      >
        Login
      </button>
      <button 
        onClick={handleOpenRegister}
        className="bg-red-700 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-md"
      >
        Register
      </button>
...
// Modified LoginForm to accept onSwitchToRegister prop
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            ...
            <div className="flex items-center justify-center mt-6 pt-4">
              <p className="text-gray-400">
                ...
                <button 
                  type="button" 
                  onClick={onSwitchToRegister} // Use prop to switch to register
...
// Modified RegistrationForm to accept onSwitchToLogin prop
const RegistrationForm = ({ onClose, onSwitchToLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.firstName || !formData.lastName || !formData.email || !formData.password || 
        !formData.phone || !formData.shirtSize || !formData.arrivalDate || !formData.role) {
      setError('Please fill in all fields');
          ...
          <form onSubmit={handleSubmit} className="space-y-5 relative z-10">
            ...
            <div className="flex items-center justify-center mt-6 pt-4">
              <p className="text-gray-400">
                ...
                <button 
                  type="button" 
                  onClick={onSwitchToLogin} // Use prop to switch to login
                  className="ml-2 text-white font-medium hover:underline"
                >
                  Login
                </button>
